    ...
    <nav className="fixed top-0 left-0 right-0 z-50 flex items-center justify-between px-6 md:px-12 py-4 bg-rich-black/60 backdrop-blur-xl border-b border-pine/30">
      <a href="#" className="flex items-center gap-3">
        <img 
          src="/logo.png" 
          alt="Trada Logo" 
          className="h-16 md:h-20 scale-150 origin-left w-auto object-contain"
        />
      </a>
      ...
      <button className="px-6 py-2.5 text-sm font-bold bg-flash-white text-rich-black rounded-full hover:bg-caribbean transition-all duration-300 hover:shadow-[0_0_15px_rgba(0,223,129,0.3)]">
        Login
      </button>
    </nav>
  );
